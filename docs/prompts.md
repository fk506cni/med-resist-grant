...
- [ ] scripts/collab/README_使い方.md が作成されている
- [ ] Markdown記法のリファレンスが含まれている
- [ ] trigger.txt の使い方が明確に説明されている
- [ ] 技術用語が最小限で、非技術者にも理解できる
...
- [ ] 共有フォルダに初期構造が配置されている
- [ ] trigger.txt → ビルド → 成果物配信の一連の流れが動作する
- [ ] Google Chat に全フェーズの通知が届く
- [ ] クールダウンが正常に機能する
- [ ] エラー時の通知と status.txt 更新が正しい
